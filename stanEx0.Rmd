...
using simplex
  categorical distribution
    y~Cat(h)  
      i=1~n, k=1~K, $y_i[1,K], h_k[0,1], \Sigma h_k=1$
      $P[y=k]=h_k$
...
data{
  int N;
  int K;
  int<lower=1,upper=K> y[N]; // R y[n],yi[1:K]
}
parameters{
  simplex[K] h;
}
